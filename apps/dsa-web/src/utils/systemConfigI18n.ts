...
const fieldTitleMap: Record<string, string> = {
  ...
  FEISHU_APP_RECEIVE_ID: '飞书个人接收 ID',
  FEISHU_APP_RECEIVE_ID_TYPE: '飞书接收 ID 类型',
...
const fieldDescriptionMap: Record<string, string> = {
  ...
  FEISHU_APP_RECEIVE_ID: '飞书应用机器人主动推送的个人接收 ID。常用 open_id，可配合 FEISHU_APP_RECEIVE_ID_TYPE 切换为 user_id、union_id、email 或 chat_id。',
  FEISHU_APP_RECEIVE_ID_TYPE: '飞书应用机器人主动推送时使用的接收 ID 类型，默认 open_id。',
